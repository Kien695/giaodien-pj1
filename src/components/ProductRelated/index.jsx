    ...
    <div className="productSlider py-4">
      ...
      >
        {props?.data.length > 0 ? (
          ...
          <div className="text-[17px] bg-gray-200 h-[70px] w-full rounded-lg shadow-lg flex items-center justify-center italic">
            Hiện chưa có sản phẩm nào liên quan đến sản phẩm này!
          </div>
        )}
      </Swiper>
    </div>
